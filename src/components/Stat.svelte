...
<style>
  .p-stat { display: flex; flex-direction: column; gap: 4px; padding: 10px 12px; border-radius: var(--p-r2); background: var(--p-s2); border: 1px solid var(--p-border); min-width: 0; }
